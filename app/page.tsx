      ...
      <div className="mt-6 flex flex-col">
        <div className="flex flex-col justify-between gap-4 border-b border-zinc-200 pb-5 lg:flex-row lg:items-center dark:border-zinc-700">
          <div className="space-y-1">
            <h2 className="text-large font-medium text-zinc-900 dark:text-zinc-100">
              Personal info
            </h2>
        ...
        >
          <div className="lg:grid-cols-form flex flex-col gap-3 pb-5 lg:grid">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Giselle" />
              </Input.Root>
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Hoekveld" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="lg:grid-cols-form flex flex-col gap-3 pb-5 lg:grid">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="giselle@gmail.com"
              />
            </Input.Root>
          </div>
